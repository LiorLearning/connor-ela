...
CONTENT: PG school-safe, age-appropriate. Fully clothed characters in modest attire. No gore, graphic injury, drugs, or weapons. 

CHARACTER SPECIFICATIONS:
MAIN CHARACTERS:
- Reese: 10-year-old Caucasian boy with black hair, wearing red cloak and green-brown adventure gear
- Oli: Reese's loyal companion and adventure partner
- Use consistent character appearances throughout all images

STORY CHARACTERS (when mentioned in prompt):
- Midgets: Small fantasy antagonists with oversized heads, short limbs, dark clothing, crystal thieves
- Dragons: Buffalo Dragons (half buffalo, half dragon) and Wolf Dragons as allies
- Only include story characters when specifically mentioned in the scene description

RESTRICTIONS: No random additional people, children, adults, or extra human figures beyond the established story characters. Focus on adventure story elements in Yellowstone setting.
